...
const HEADER_ITEMS = [
  ...
  },
  {
    ...
    url: "/semaglutide-injections",
    order: 1,
    parentKey: "Weight Loss",
  },
  {
    label: "Tirzepatide Injections Rx",
    url: "/tirzepatide-injections",
    order: 2,
    parentKey: "Weight Loss",
  },
  {
    label: "Tirzepatide Drops Rx",
    url: "/tirzepatide-drops",
    order: 3,
    parentKey: "Weight Loss",
  },
  {
    label: "Tirzepatide Tablets Rx",
    url: "/tirzepatide-tablets",
    order: 4,
    parentKey: "Weight Loss",
  },
  // Anti-aging sub-items
  {
    label: "NAD+ Injection Rx",
    url: "/nad",
    order: 0,
    parentKey: "Anti-aging",
  },
  {
    label: "NAD+ Nasal Spray Rx",
    url: "/nad-nasal-spray",
    order: 1,
    parentKey: "Anti-aging",
  },
  {
    label: "NAD+ Patches Rx",
    url: "/nad-patches",
    order: 2,
    parentKey: "Anti-aging",
  },
  {
    label: "MICC+B12 Shots Rx",
    url: "/mic-injection",
    order: 3,
    parentKey: "Anti-aging",
  },
  ...
  },
  {
    ...
    url: "/sermorelin-injection-2",
    order: 1,
    parentKey: "Strength & Recovery",
  },
  {
    label: "CJC-1295 + Ipamorelin Rx",
    url: "/cjc-1295-ipamorelin",
    order: 2,
    parentKey: "Strength & Recovery",
  },
  {
  ...
  {
    label: "PT-141 Nasal Spray Rx",
    url: "/pt-141-nasal-spray",
    order: 1,
    parentKey: "Sexual Health",
  },
  {
    label: "Oxytocin Nasal Spray Rx",
    url: "/oxytocin-nasal-spray",
    order: 2,
    parentKey: "Sexual Health",
  },
  {
    label: "PT-141 + Oxytocin Rx",
    url: "/pt-141-surge-2-in-1",
    order: 3,
    parentKey: "Sexual Health",
  },
  {
    label: "Viagra | Sildenafil Rx",
    url: "/viagra-sildenafil",
    order: 4,
    parentKey: "Sexual Health",
  },
];
