...
- `user messages api` — PASS — 30 messages
- `user projection` — PASS — mdi-patient-1774533437229
- `order projection` — PASS — case mdi-case-1774533437229 / encounter mdi-encounter-1774533437229
- `case snapshot projection` — PASS — status completed
- `message sync projection` — PASS — mdi-patient-1774533437229
