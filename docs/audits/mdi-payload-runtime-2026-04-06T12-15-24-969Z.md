...
- Generated at: `2026-04-06T12:15:24.969Z`
- Base URL: `http://127.0.0.1:3000`
- Demo user: `demo@healsend.com`
- Order ID: `cmnfllubk001qmt0usfrl4wkm`
- Case ID: `mdi-payload-case-1775477724642`
- Checks: `13`
- Passing: `13`
- Failing: `0`
...
- `user visits reflect variant payloads` — PASS — 9 visits
- `user messages reflect variant payloads` — PASS — 30 messages
