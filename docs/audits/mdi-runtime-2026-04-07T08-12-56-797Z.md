...
- Generated at: `2026-04-07T08:12:56.797Z`
- Base URL: `http://127.0.0.1:3000`
- Demo user: `demo@healsend.com`
- Order ID: `cmnfllubk001qmt0usfrl4wkm`
- Case ID: `mdi-case-1775549576501`
- Checks: `13`
- Passing: `13`
- Failing: `0`
...
- `user visits api` — PASS — 13 visits
- `user messages api` — PASS — 14 messages
- `user projection` — PASS — mdi-patient-1775549576501
- `order projection` — PASS — case mdi-case-1775549576501 / encounter mdi-encounter-1775549576501
- `case snapshot projection` — PASS — status completed
- `message sync projection` — PASS — mdi-patient-1775549576501
