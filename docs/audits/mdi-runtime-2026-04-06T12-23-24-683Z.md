...
- Generated at: `2026-04-06T12:23:24.683Z`
- Base URL: `http://127.0.0.1:3000`
- Demo user: `demo@healsend.com`
- Order ID: `cmnfllubk001qmt0usfrl4wkm`
- Case ID: `mdi-case-1775478204511`
- Checks: `13`
- Passing: `13`
- Failing: `0`
...
- `user visits api` — PASS — 10 visits
- `user messages api` — PASS — 34 messages
- `user projection` — PASS — mdi-patient-1775478204511
- `order projection` — PASS — case mdi-case-1775478204511 / encounter mdi-encounter-1775478204511
- `case snapshot projection` — PASS — status completed
- `message sync projection` — PASS — mdi-patient-1775478204511
