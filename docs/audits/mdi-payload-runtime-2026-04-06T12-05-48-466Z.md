...
- Generated at: `2026-04-06T12:05:48.466Z`
- Base URL: `http://127.0.0.1:3000`
- Demo user: `demo@healsend.com`
- Order ID: `cmnfllubk001qmt0usfrl4wkm`
- Case ID: `mdi-payload-case-1775477148034`
- Checks: `13`
- Passing: `12`
- Failing: `1`
...
- `user visits reflect variant payloads` — PASS — 3 visits
- `user messages reflect variant payloads` — PASS — 6 messages
