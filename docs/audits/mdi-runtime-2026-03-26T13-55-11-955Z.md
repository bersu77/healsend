...
- `user visits api` — PASS — 5 visits
- `user messages api` — PASS — 18 messages
- `user projection` — PASS — mdi-patient-1774533311805
- `order projection` — PASS — case mdi-case-1774533311805 / encounter mdi-encounter-1774533311805
- `case snapshot projection` — PASS — status completed
- `message sync projection` — PASS — mdi-patient-1774533311805
