...
- Generated at: `2026-04-06T12:15:24.230Z`
- Base URL: `http://127.0.0.1:3000`
- Demo user: `demo@healsend.com`
- Order ID: `cmnfllubk001qmt0usfrl4wkm`
- Case ID: `mdi-case-1775477724075`
- Checks: `13`
- Passing: `13`
- Failing: `0`
...
- `user messages api` — PASS — 26 messages
- `user projection` — PASS — mdi-patient-1775477724075
- `order projection` — PASS — case mdi-case-1775477724075 / encounter mdi-encounter-1775477724075
- `case snapshot projection` — PASS — status completed
- `message sync projection` — PASS — mdi-patient-1775477724075
