...
- Generated at: `2026-04-06T12:04:42.496Z`
- Base URL: `http://127.0.0.1:3000`
- Demo user: `demo@healsend.com`
- Order ID: `cmnfllubk001qmt0usfrl4wkm`
- Case ID: `mdi-case-1775477081241`
- Checks: `13`
- Passing: `13`
- Failing: `0`
...
- `user projection` — PASS — mdi-patient-1775477081241
- `order projection` — PASS — case mdi-case-1775477081241 / encounter mdi-encounter-1775477081241
- `case snapshot projection` — PASS — status completed
- `message sync projection` — PASS — mdi-patient-1775477081241
